						...
						(n = [
							{
								...
								value: function (t) {
									return (
										(this.positions.top = t ? t.scrollTop : window.pageYOffset), this.positions
									);
								},
							},
							{
				...
				return (
					...
					(n = [
						...
						},
						{
							...
							value: function () {
								return (
									this.elementBottom > s.positions.top && this.elementTop < s.positions.bottom
								);
							},
						},
						{
					...
					return (
						...
						(n = [
							...
							},
							{
								...
								value: function () {
									if (
										(s.setViewportTop(this.customContainer), this.lastPosition !== s.positions.top)
									) {
										s.setViewportBottom();
							...
							},
							{
								key: "proceedElement",
								value: function (t) {
									(!g || this.customContainer ? t.checkIfVisible() : t.isVisible) &&
										t.getTranslateValue() &&
										t.animate();
								},
							},
